...
class OnboardingRequest(BaseModel):
    ...
    category_slugs: List[str] = []  # empty = mixed default
...
class StoryOut(BaseModel):
    ...
    @classmethod
    def parse_verification_flags(cls, v):
        return _parse_json_list(v)

    @field_validator("verifier_report", mode="before")
    @classmethod
    def parse_verifier_report(cls, v):
...
class ApiKeyCreatedOut(ApiKeyOut):
    """Only returned ONCE, at creation time - the raw key is never retrievable again."""
    raw_key: str
